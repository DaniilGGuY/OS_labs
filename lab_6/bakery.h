...
extern  double * bakery_service_1(struct REQUEST *, CLIENT *);
extern  double * bakery_service_1_svc(struct REQUEST *, struct svc_req *);
...
#define BAKERY_SERVICE 2
extern  double * bakery_service_1();
extern  double * bakery_service_1_svc();
